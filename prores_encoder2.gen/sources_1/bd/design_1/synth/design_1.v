...
module design_1
  ...
  wire [3:0]signal_controller_wr_0_STATUS;
  ...
  design_1_myip_0_0 myip_0
       (.INPUT_ADDRESS(myip_0_INPUT_ADDRESS),
        ...
        .START(myip_0_START),
        .STATUS1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,signal_controller_wr_0_STATUS}),
  ...
  design_1_signal_controller_wr_0_0 signal_controller_wr_0
       (.ADDRB(signal_controller_wr_0_ADDRB),
        ...
        .RSTB(signal_controller_wr_0_RSTB),
        .START(myip_0_START),
        .STATUS(signal_controller_wr_0_STATUS),
        .STATUS2(signal_controller_wr_0_STATUS2),
        .WEB(signal_controller_wr_0_WEB));
